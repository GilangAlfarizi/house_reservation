...
<div class="relative w-full h-screen">
    ...
    <div class="py-40 my-40 text-center">
    <section class="bg-center bg-no-repeat bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <div class="grid gap-y-8 gap-x-8 m-10 px-32">
                <div class="flex justify-center gap-x-8">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">BOGAS 5</h5>
                            </a>
