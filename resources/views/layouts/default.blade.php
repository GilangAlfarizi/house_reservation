        ...
        <nav class="bg-[#8F8B55] fixed w-full z-20 top-0 start-0">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <a href="/contact"
                        class="text-white bg-gray-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Chat
                        Langsung</a>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a href="/"
                                class="{{ Request::is('/') ? 'text-black ' : 'text-white' }} hover:text-gray-400 block py-2 px-3">Home</a>
                        </li>
                        <li>
                            <a href="/houses"
                                class="{{ Request::is('houses') ? 'text-black ' : 'text-white' }} hover:text-gray-400 block py-2 px-3">Projects</a>
                        </li>
                        <li>
                            <a href="/contact"
                                class="{{ Request::is('contact') ? 'text-black ' : 'text-white' }} hover:text-gray-400 block py-2 px-3">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
