...
<body class="bg-gray-100">
    <header class="flex justify-center fixed top-0 left-0 right-0 z-10">
        <div class="bg-[#8F8B55] text-white my-4 flex items-center font-lora rounded-3xl px-8">
        ...
        <div class="ml-auto">
            <div class="dropdown relative" aria-labelledby="navbarDropdown">
                <a class="text-white ml-4" href="{{ route('logout') }}"
    ...
    <footer class="mt-10 bg-gray-800 text-white py-4">
        <img src="{{ asset('images/IMG-20240508-WA0064.jpg') }}" alt="logo" class="mx-auto w-40 h-30">
