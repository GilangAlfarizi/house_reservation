            ...
            <div class=" flex flex-wrap items-center justify-between p-8">
              ...
              @auth
                    ...
                    <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                      ...
                      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-dropdown">
                        ...
                        <ul class="py-2 bg-white-900" aria-labelledby="user-menu-button">
                          ...
                          <li>
                            <a href="" class="block px-4 py-2 text-sm text-gray-900 hover:bg-gray-200">
                              Change Password
                            </a>
                          </li>
                          <li>
                ...
                <ul class="flex font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white-900">
                    <li>
                      <a href="" class="{{ Request::routeIs('categories.index') ? 'text-blue-700' : 'text-gray-900' }} text-lg rounded md:bg-transparent md:hover:text-blue-700 md:p-0" aria-current="page">Categories</a>
                    </li>
                    <li>
                        <a href="" class="{{ Request::routeIs('projects.index') ? 'text-blue-700' : 'text-gray-900' }} text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Projects</a>
                    </li>
                    <li>
                        <a href="" class="{{ Request::routeIs('crews.index') ? 'text-blue-700' : 'text-gray-900' }} text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Crews</a>
                    </li>
                </ul>
                </div>
                @endauth
